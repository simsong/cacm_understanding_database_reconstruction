...
The data in Table 4 is the 'ground truth' database that the attacker wishes to reconstruct. At the start of the attack, the attacker writes the table of 25 unknowns given in Table 5.
...
This can be written as a linear constraint equation using the symbols for age, A1...10 given in Table 5: \footnote{Multiplication by 100 is used to avoid floating-point rounding errors.}
