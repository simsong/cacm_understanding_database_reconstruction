...
\begin{enumerate}
    ...
    \item To what extent are modern DRAs effective in reconstructing confidential statistical databases?
    \item How scalable are DRAs with database size?
    \item How can a modern statistical agency avoid disclosure of confidential data without significantly impacting the accuracy of the data?
\end{enumerate}
