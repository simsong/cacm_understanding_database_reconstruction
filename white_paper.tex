...
%Especially noteworthy in the discussion of noise infusion techniques
%is a special type of noise infusion called the Laplace Mechanism .
%The mathematics behind this process are beyond the scope of this
%paper, but the important property of this distribution is that it is
%effective in creating noise that minimally impacts the utility of the
%statistics while still ensuring individual privacy. Informally, the
%proper addition of Laplace noise ensures that the choice of any
%individual to respond or not respond to a survey does not
%significantly impact the published data from the survey. Therefore, a
%person is free to respond truthfully to a survey covered by Laplace
%noise infusion without worrying that his privacy will be compromised
%by his choice to respond.
