...
individual survey responses. Specifically, all Census publications must uphold the
...
that the number of tabulations required to enable a reconstruction
attacks is far fewer than might be intuitively expected: this is
...
individuals suffer as a result of a data publication, and proposes a
...
\hline
  1A & All            & 7     &  30    & 35.28 \\
\hline
  2A & Females        & 4     &  30    & 32.75 \\
  2B & Males          & 3     &  30    & 38.66 \\
  2C & Blacks         & 4     &  51    & 43.75 \\
  2D & Whites         & 3     &  24    & 24.00 \\
\hline
  3A & Single adults  & 2     & \cens  & 21.00 \\
  3B & Married adults & 4     & \cens  & 50.00 \\
\hline
  4A & Black females  & 3     & \cens  & \cens \\
  4B & White males    & \cens & \cens  & \cens \\
\hline
  5A & Children $\le 5$   & \cens         & \cens  & \cens \\
  5B & Teenagers (14--17) & \cens         & \cens  & \cens \\
  5C & Senior Citizens ($\ge 65$) & \cens & \cens  & \cens \\
\hline
\multicolumn{5}{l}{Note: Married individuals must be 15 or over}
\end{tabular}
